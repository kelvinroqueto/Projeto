...
class ProductsController extends Controller
{
    ...
    {
        #outra forma de fazser esse find com o repository ao inves de instanciar a classe a baixo
        # $products = $this->repository->findWhere(['institution_id' => $institution_id]);
        $institution = Institution::find($institution_id);
 
     
        return view('institutions.products.index', ['institution' => $institution]);
    }
    ...
    public function store(Request $request, $institution_id)
    {
            ...
            session()->flash('success', [
                ...
                return redirect()->route('institution.product.index', ['institution_id' => $institution_id] );
    ...
    {
        $request = $this->service->destroy($product_id);
        session()->flash('success', [
            'success' => true,
            'messages' => $request['messages']
            ]);
